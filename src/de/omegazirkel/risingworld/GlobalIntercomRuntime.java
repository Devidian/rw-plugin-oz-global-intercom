 ...
 */
class GlobalIntercomRuntime extends Plugin {
	...
	public void onEnable() {
		...
		serverThreadDispatcher = new ServerThreadDispatcher(this);
			s = PluginSettings.getInstance((GlobalIntercom) this);
		...
		playerSettings = new PlayerSettings(sqliteCon);
			...
			wsh = new WebSocketHandler((GlobalIntercom) this);
		connectRelay(true);
		AssetManager.loadIconFromPlugin(this, "oz-global-intercom");
		...
		PlayerPluginSettingsOverlay.registerPlayerPluginAdminSettings(
			...
			PluginInfoStatusProviders
						.registerProvider(new GlobalIntercomPluginInfoStatusProvider(
								(GlobalIntercom) this, getDescription("version")));
			PluginShortcutVisibility.register(name, GlobalIntercomPlayerPluginSettings::shortcutVisible);
			PluginMenuManager.registerPluginMenu(new MenuItem(name, "oz-global-intercom",
